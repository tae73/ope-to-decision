...
> **M8 註 (2026-08-10).** 아래 5권은 M8(GT-미상 본편 재정위 — README·PLAN §3.5) **반영 전**
> 상태의 파생층이다 — 내용은 여전히 유효하나 무대 라벨(본편/백스테이지)과 GT-미상 프로토콜
> walkthrough 권(05)은 후속 마일스톤(M9) 소관. 01권의 "합성 DGP 해부"는 현행 서사에서
> **백스테이지 정본**에 해당한다(GLOSSARY §8).
